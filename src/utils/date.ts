/**
 * App-weite Datums-Utils
 * Pfad: src/utils/date.ts
 * Von ImportExcel/ImportPdf/Sync genutzt.
 */
...
/**
 * Robust: akzeptiert 'dd.mm.yyyy', 'yyyy-mm-dd', ISO, sowie Date/epoch string.
 * Gibt ISO (yyyy-mm-ddTHH:mm:ss.sssZ) zurück oder wirft bei ungültigem Input.
 */
export function parseToISO(input: string): string {
  ...
  // yyyy-mm-dd (optional time omitted)
...
// Optional Re-Exports, damit Call-Sites konsistent bleiben, falls genutzt
